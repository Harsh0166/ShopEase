<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($product_add_result){
            ...
            header("Location: product_manage.php?msg=1");
        }
        else{
             header("Location: product_manage.php?msg=2");
        }
...
<div class="dashboard-content">
  ...
  <script>
    ...
    //   e.preventDefault();
    //   alert("Product submitted successfully (functionality to save not implemented yet).");
    // });

    var loc = window.location.href;
    loc=loc.split("?")[1].split("=")[1];
    if(loc == 1){
